...
const char* ssid = "Tacmesh_Controller_Gateway";
const char* pswd = "P@ssw0rd*!";
const char* mqtt_server = "192.168.116.154";
...
IPAddress local_IP(192, 168, 116, 183);
// Set your Gateway IP address
IPAddress gateway(192, 168, 116, 27);
...
void loop() {
  ...
  double voltage = map(volt, 0, 1023, 0, 1300) + offset; // map 0-1023 to 0-2500 and add correction offset
  ...
  if (updateonce == false) {
    ...
    delay(10);
    client.publish("tacmesh/battery2" , payload.c_str());
...
//    client.publish("tacmesh/battery" , payload.c_str());
//  }
//}
