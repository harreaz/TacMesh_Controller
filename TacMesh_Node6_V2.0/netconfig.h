...
#define HostName "Node6"
const char* ssID = "Grand Orchardz Kemayoran";                     // change which SSID of tacmesh radio controller would connect
const char* passWord = "orchardz21";                 // password of the SSID
